...
velocity_values = velocity_x[530:779].values.astype('float64')

velocity_y = df[df.columns[8]]

velocity_y_values = velocity_y[530:779].values.astype('float64')
...
force_values = force_x[530:779].values.astype('float64')

force_y = df[df.columns[2]]

force_y_values = force_y[530:779].values.astype('float64')
...
if __name__ == '__main__':
    ...
    phi_df.to_csv('phi_values_3_6-adv.csv')
