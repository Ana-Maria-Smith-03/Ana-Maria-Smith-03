...
velocity_values = velocity_x[1002:1533].values.astype('float64')

velocity_y = df[df.columns[2]]

velocity_y_values = velocity_y[1002:1533].values.astype('float64')
...
force_values = force_x[1002:1533].values.astype('float64')

force_y = df[df.columns[7]]

force_y_values = force_y[1002:1533].values.astype('float64')
...
if __name__ == '__main__':
    ...
    phi_df.to_csv('phi_values_4_6-circ.csv')
